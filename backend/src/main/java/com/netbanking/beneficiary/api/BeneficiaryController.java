...
public class BeneficiaryController {
    ...
    @PostMapping("/{beneficiaryId}/activation-challenges") @ResponseStatus(HttpStatus.CREATED) public BeneficiaryOtpChallengeResponse issueActivationOtp(@PathVariable Long beneficiaryId) { return service.issueActivationOtp(SecurityContextHelper.currentUserId(), beneficiaryId); }
    @PostMapping("/{beneficiaryId}/activate") public BeneficiaryResponse activate(@PathVariable Long beneficiaryId, @Valid @RequestBody BeneficiaryActivationRequest request) { return service.activate(SecurityContextHelper.currentUserId(), beneficiaryId, request); }
