...
public class UserTotp {
    ...
    @Column(name = "last_used_time_step") private Long lastUsedTimeStep;
    protected UserTotp() { }
    ...
    public void replaceSecret(String secretCiphertext) { this.secretCiphertext = secretCiphertext; this.isEnabled = "N"; this.confirmedAt = null; this.lastUsedTimeStep = null; }
