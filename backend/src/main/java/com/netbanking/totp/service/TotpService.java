...
public class TotpService {
    ...
    public TotpService(UserTotpRepository repository, TotpSecretCipher cipher,
                       ...
                       SecretGenerator secretGenerator, CodeVerifier verifier, CodeGenerator codeGenerator,
                       QrGenerator qrGenerator, TimeProvider timeProvider) {
    ...
    public void verifyLogin(AppUser user, String code) {
        ...
        if (!credential.isEnabled()) throw new UnauthorizedException("Authenticator code is invalid.");
