...
public class BillPayment {
    ...
    public BillPayment(Long transactionId, Long sourceAccountId, Long billerId, Long userId, String billReference, String idempotencyKey) { this.transactionId = transactionId; this.sourceAccountId = sourceAccountId; this.billerId = billerId; this.initiatedByUserId = userId; this.billReference = billReference; this.idempotencyKey = idempotencyKey; this.paymentStatus = "COMPLETED"; }
    public Long getBillPaymentId() { return billPaymentId; } public Long getTransactionId() { return transactionId; } public String getPaymentStatus() { return paymentStatus; }
}
