...
public class ApiExceptionHandler {
    ...
    Map<String, String> unauthorized(RuntimeException exception) {
        return Map.of("message", exception.getMessage());
    }
    ...
    Map<String, String> forbidden(SecurityException exception) {
        return Map.of("message", exception.getMessage());
    }

    @ExceptionHandler(IllegalStateException.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    Map<String, String> illegalState(IllegalStateException exception) {
        return Map.of("message", exception.getMessage());
    }
}
