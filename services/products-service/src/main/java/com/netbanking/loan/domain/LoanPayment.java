...
public class LoanPayment {
    ...
    public LoanPaymentStatus getPaymentStatus() {
    ...
    public boolean matchesRequest(String fingerprint) {
        return fingerprint != null && fingerprint.equals(requestFingerprint);
    }

    public void bindLegacyRequest(String fingerprint) {
