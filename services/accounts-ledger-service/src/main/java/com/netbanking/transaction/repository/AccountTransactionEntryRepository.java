...
public interface AccountTransactionEntryRepository
        extends JpaRepository<AccountTransactionEntry, Long>,
    ...
    @Override
    @EntityGraph(attributePaths = "transaction")
    Page<AccountTransactionEntry> findAll(
            Specification<AccountTransactionEntry> specification, Pageable pageable);
