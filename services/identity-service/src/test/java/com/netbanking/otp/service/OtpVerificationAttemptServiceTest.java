...
class OtpVerificationAttemptServiceTest {
    ...
    void locksAndConsumesAChallengeExactlyOnce() {
        ...
        var result =
                service().verify(7L, "challenge", "123456", OtpPurpose.FUND_TRANSFER, "intent");
    ...
    void persistsFailedAttemptsBeforeReportingAnInvalidCode() {
        ...
        var result =
                service().verify(7L, "challenge", "000000", OtpPurpose.FUND_TRANSFER, "intent");
    ...
    private static OtpVerification otp(Instant expiresAt, String intent) {
        return new OtpVerification(
                7L, "challenge", "hash", OtpPurpose.FUND_TRANSFER, expiresAt, intent);
    }
}
