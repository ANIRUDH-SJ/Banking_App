...
public class PaymentAuditService {
    ...
    public void recordSuccess(
            Long userId, Long sourceAccountId, String operation, String transactionReference) {
    ...
    public void recordRejected(
            Long userId, Long sourceAccountId, String operation, RuntimeException failure) {
        String outcome = isDenied(failure) ? "DENIED" : "FAILURE";
        auditLogService.record(
                userId,
                operation + "_REJECTED",
                "ACCOUNT",
                sourceAccountId == null ? null : String.valueOf(sourceAccountId),
                outcome,
