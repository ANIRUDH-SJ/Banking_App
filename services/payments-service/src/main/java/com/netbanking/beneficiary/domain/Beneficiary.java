...
public class Beneficiary {
    ...
    public Beneficiary(
        ...
        this.beneficiaryStatus = "PENDING";
    }
    ...
    public boolean isActive() {
        return "ACTIVE".equals(beneficiaryStatus);
    }

    public void requirePendingForActivation() {
        if (!"PENDING".equals(beneficiaryStatus))
            throw new IllegalStateException("Only a pending beneficiary can be activated.");
    }
